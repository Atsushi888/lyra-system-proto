...
class EmotionModel:
    ...
    - relationship_stage / relationship_label の自動計算
    などの「振る舞い」をまとめるクラス。
    ...
    def sync_relationship_fields(self) -> None:
        """
        現在の affection_effective から relationship_stage / label を再計算し、
    ...
    def to_override_emotion_dict(self) -> Dict[str, Any]:
        """
        MixerAI や emotion_prompt_builder に渡すことを想定した
